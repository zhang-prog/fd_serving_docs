...
public class Main {
    public static void main(String[] args) throws IOException {
        String API_URL = "https://localhost:8080/multilabel-image-classification"; // 服务URL
...
func main() {
	API_URL := "https://localhost:8080/multilabel-image-classification"
	imagePath := "./demo.jpg"
...
class Program
{
    static readonly string API_URL = "https://localhost:8080/multilabel-image-classification";
...
const API_URL = 'https://localhost:8080/multilabel-image-classification'
