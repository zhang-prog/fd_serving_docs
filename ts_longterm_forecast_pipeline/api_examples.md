...
- **`infer`**
    ...
    - 请求处理成功时，响应体的`result`具有如下属性：
        ...
        |`image`|`string`|时序预测结果图。图像为JPEG格式，使用Base64编码。|
...
API_URL = "https://localhost:8080/time-series-forecasting" # 服务URL
csv_path = "./test.csv"
...
public class Main {
    public static void main(String[] args) throws IOException {
        String API_URL = "https://localhost:8080/time-series-forecasting";
...
func main() {
	API_URL := "https://localhost:8080/time-series-forecasting"
	csvPath := "./test.csv";
...
class Program
{
    static readonly string API_URL = "https://localhost:8080/time-series-forecasting";
...
const API_URL = 'https://localhost:8080/time-series-forecasting'
